    ...
    def __init__(self, base64_string: str):
        ...
        if self._base64_string:
            ...
            try:
                ...
                if "," in self._base64_string:
                    self._base64_string = self._base64_string.split(",")[1]

                # Ajusta padding se necessário
                missing_padding = len(self._base64_string) % 4
                if missing_padding:
                    self._base64_string += "=" * (4 - missing_padding)                    
                ...
                self._message_error = f"Erro ao decodificar Base64: {e}"
                print("DEBUG Base64 (primeiros 100 chars):", self._base64_string[:100])
                return None
