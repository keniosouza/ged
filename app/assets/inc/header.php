                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="text-dark mb-0"><?php echo $_SESSION['MY_SAAS_USER']->name; ?></h6>
                                        <span class="fs-12 fw-medium text-muted"><?php echo $_SESSION['MY_SAAS_USER']->email; ?></span>
                                    </div>
                                </div>
                            </div>

                            <a href="javascript:void(0);" class="dropdown-item" onclick="new Request({'request': {'path' : 'view/users/users_form'}, 
                                                                                                      'loader' : {'type' : 3},   
                                                                                                      'params' : {'user_id' : '<?php echo $_SESSION['MY_SAAS_USER']->user_id; ?>'}})">
                                <i class="feather-settings"></i>
                                <span>Dados do cadastro</span>
                            </a>

                            <script>
                                var procedure = "new Request({'request' : {'path' : 'action/users/users_logout'}, 'loader' : {'type' : 3}})";
                            </script>

                            <div class="dropdown-divider"></div>
                            <a href="#" class="dropdown-item" onclick="new Modal({ title: 'Atenção', data: '<h3 class=\'text-center\'>Deseja realmente sair da aplicação?</h3>', size: 'small', type: 'bi bi-door-closed', procedure: procedure });">
