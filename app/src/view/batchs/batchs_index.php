...
try {
    ...
    $BatchsValidate->setStart($start);
    $BatchsValidate->setPage($page);
    $BatchsValidate->setMax($max);
    $BatchsValidate->setSearch($search);

    /** Consulta a quantidade de registros */
    $rows = $Batchs->Count($BatchsValidate->getSearch());

    /** Busco todos os registros */
    $BatchsAllResult = $Batchs->All(
        $BatchsValidate->getStart(),
        $BatchsValidate->getMax(),
        $BatchsValidate->getSearch()
    );
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Lotes</h5>
            </div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="home">Home</a></li>
                <li class="breadcrumb-item">Lotes de arquivos</li>
            </ul>
        </div>
        ...
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    <form id="frmSearch" class="float-end w-100" action="javascript:void">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                ...
                                name="search"
                                wfd-id="id6"
                                value="<?php echo $BatchsValidate->getSearch(); ?>"
                                data-required="S">

                            <button class="btn btn-outline-secondary" id="btnSearch" type="button" onclick='validateForm("#frmSearch", `{"request": {"path" : "view/batchs/batchs_index"},
                    ...
                    <button class="btn btn-primary" onclick='new Request({"request" : {"path" : "view/batchs/batchs_form"}, 
                                                                          "loader" : {"type" : 3},
                                                                          "form" : null})'>
                ...
                <div class="card stretch stretch-full">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php if ($rows > 0) { ?>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($BatchsAllResult as $key => $result) { ?>

                                            <tr class="align-middle border-top" id="<?php echo $result->batch_id; ?>">

                                                <td scope="row" class="text-center" width="60">

                                                    <?php echo $result->batch_id ?>
                                                ...
                                                <td class="text-center" class="text-center" width="120">

                                                    <?php echo $result->type; ?>

                                                </td>

                                                <td class="text-center" class="text-center" width="160">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu shadow-sm">
                                                            ...
                                                            <li>
                                                                ...
                                                                <a class="dropdown-item" onclick='new Request({"request": {"path" : "view/batchs/batchs_form"}, 
                                                                                                               "params" : {"batch_id" : "<?php echo $result->batch_id ?>"},
                                                                                                               "loader" : {"type" : 3}})'>
                                                            ...
                                                            <li>
                                                                ...
                                                                <a class="dropdown-item" id="BatchsBtnFiles" onclick='new Request({"request": {"path" : "view/files/files_form_upload"},                                                                                                                                    
                                                                                                                                   "params" : {"batch_id" : "<?php echo $result->batch_id ?>"},
                                                                                                                                   "response" : {"target" : "app-main"},
                                                                                                                                   "loader" : {"type" : 3}})'>

                                                                    <i class="bi bi-files me-1"></i>Enviar Arquivos
                                                            ...
                                                            <li>
                                                                ...
                                                                <a class="dropdown-item" id="BatchsBtnRemove" onclick='new Request({"request": {"path" : "action/batchs/batchs_delete"}, 
                                                                                                                                    "params" : {"batch_id" : "<?php echo $result->batch_id ?>"},
                                                                                                                                    "loader" : {"type" : 3}})'>
                            ...
                            <?php } else { ?>
                                ...
                                <div class="alert alert-warning m-4" role="alert">
                                    Não há lotes de arquivos cadastrados
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        if ($rows > $max) {
                            ...
                            /** Link da solicitação */
                            $jsonData['request'] = [];
                            $jsonData['request']['path'] = 'view/batchs/batchs_index';
            ...
            $(document).ready(function(e) {
                ...
                $('input[name="search"]').keypress(function(event) {
                    ...
                    if (keycode == '13') {
                        ...
                        validateForm("#frmSearch", `{"request": {"path" : "view/batchs/batchs_index"},
                                                             "loader" : {"type" : 1, "target" : "btnSearch"}, 
                                                             "response" : {"target" : "app-main"},
                                                             "form" : "frmSearch"}`)
