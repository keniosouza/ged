...
try {
    ...
    $FilesTypesValidate->setSearch($search);
    $FilesTypesValidate->setStart($start);
    $FilesTypesValidate->setPage($page);
    $FilesTypesValidate->setMax($max);

    /** Consulta a quantidade de registros */
    $rows = $FilesTypes->Count(
        $FilesTypesValidate->getSearch()
    );

    /** Retorna os registros com paginação */
    $FilesTypesResult = $FilesTypes->All(
        $FilesTypesValidate->getStart(),
        $FilesTypesValidate->getMax(),
        $FilesTypesValidate->getSearch()
    )
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">Tipos de Arquivos</li>
            </ul>
        </div>
        ...
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    <form id="frmSearch" class="float-end w-100" action="javascript:void">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                ...
                                name="search"
                                wfd-id="id6"
                                value="<?php echo $FilesTypesValidate->getSearch(); ?>"
                                data-required="S">

                            <button class="btn btn-outline-secondary" id="btnSearch" type="button" onclick='validateForm("#frmSearch", `{"request": {"path" : "view/files_types/files_types_index"},
                    ...
                    <button class="btn btn-primary" onclick='new Request({"request" : {"path" : "view/files_types/files_types_form"}, 
                                                                          "loader" : {"type" : 3},
                                                                          "form" : null})'>
                ...
                <div class="card stretch stretch-full">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php if ($rows > 0) { ?>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($FilesTypesResult as $key => $result) { ?>

                                            <tr class="align-middle border-top" id="<?php echo $result->file_type_id ?>">

                                                <td scope="row" class="text-center" width="60">

                                                    <?php echo $result->file_type_id ?>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu shadow-sm">
                                                            ...
                                                            <li>
                                                                ...
                                                                <a class="dropdown-item" onclick='new Request({"request": {"path" : "view/files_types/files_types_form"}, 
                                                                                                           "params" : {"file_type_id" : "<?php echo $result->file_type_id ?>"},
                                                                                                           "loader" : {"type" : 3}})'>
                                                            ...
                                                            <li>
                                                                ...
                                                                <a class="dropdown-item" id="FilesTypesBtnRemove" onclick='new Request({"request": {"path" : "action/files_types/files_types_delete"}, 
                                                                                                                                    "params" : {"file_type_id" : "<?php echo $result->file_type_id ?>"},
                                                                                                                                    "loader" : {"type" : 3}})'>
                            ...
                            <?php } else { ?>
                                ...
                                <div class="alert alert-warning m-4" role="alert">
                                    Não há tipos de arquivos cadastrados
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        if ($rows > $max) {
                            ...
                            /** Link da solicitação */
                            $jsonData['request'] = [];
                            $jsonData['request']['path'] = 'view/files_types/files_types_index';
        ...
        $(document).ready(function(e) {
            ...
            $('input[name="search"]').keypress(function(event) {
                ...
                if (keycode == '13') {
                    ...
                    validateForm("#frmSearch", `{"request": {"path" : "view/files_types/files_types_index"},
                                                             "loader" : {"type" : 1, "target" : "btnSearch"}, 
                                                             "response" : {"target" : "app-main"},
                                                             "form" : "frmSearch"}`)
