...
try {
    ...
    $ModulesValidate->setStart($start);
    $ModulesValidate->setPage($page);
    $ModulesValidate->setMax($max);
    $ModulesValidate->setSearch($search);

    /** Consulta a quantidade de registros */
    $rows = $Modules->Count($ModulesValidate->getSearch());

    /** Busco todos os registros */
    $ModulesAllResult = $Modules->All(
        $ModulesValidate->getStart(),
        $ModulesValidate->getMax(),
        $ModulesValidate->getSearch()
    );
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Módulos</h5>
            </div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="home">Home</a></li>
                <li class="breadcrumb-item">Módulos/Permissões</li>
            </ul>
        </div>
        ...
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    <form id="frmSearch" class="float-end w-100" action="javascript:void">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                ...
                                name="search"
                                wfd-id="id6"
                                value="<?php echo $ModulesValidate->getSearch(); ?>"
                                data-required="S">

                            <button class="btn btn-outline-secondary" id="btnSearch" type="button" onclick='validateForm("#frmSearch", `{"request": {"path" : "view/modules/modules_index"},
                    ...
                    <button class="btn btn-primary" onclick='new Request({"request" : {"path" : "view/modules/modules_form"}, 
                                                                          "loader" : {"type" : 3},
                                                                          "form" : null})'>
                ...
                <div class="card stretch stretch-full">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    foreach ($ModulesAllResult as $key => $result) { ?>

                                        <tr class="align-middle border-top" id="<?php echo $result->module_id ?>">
                                            ...
                                            <td class="text-center" width="60" id="<?php echo $result->modules_id ?>">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu shadow-sm">
                                                        ...
                                                        <li>
                                                            ...
                                                            <a class="dropdown-item" onclick='new Request({"request": {"path" : "view/modules/modules_form"}, 
                                                                                                       "loader" : {"type" : 3},   
                                                    ...
                                                    <li>
                                                        ...
                                                        <a class="dropdown-item" onclick=' new Request({"request" : {"path" : "view/modules/modules_details" }, "loader" : {"type" : 3}, "params" : {"module_id" : "<?php echo $result->module_id ?>" }})'>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a class="dropdown-item" onclick='new Request({"request" : {"path" : "action/modules/modules_delete"}, 
                                                                                                       "params" : {"module_id" : "<?php echo $result->module_id ?>"},
                                                                                                       "loader" : {"type" : 3}})'>
                    ...
                    <div class="card-footer clearfix">
                        ...
                        if ($rows > $max) {
                            ...
                            /** Link da solicitação */
                            $jsonData['request'] = [];
                            $jsonData['request']['path'] = 'view/modules/modules_index';
        ...
        $(document).ready(function(e) {
            ...
            $('input[name="search"]').keypress(function(event) {
                ...
                if (keycode == '13') {
                    ...
                    validateForm("#frmSearch", `{"request": {"path" : "view/modules/modules_index"},
                                                             "loader" : {"type" : 1, "target" : "btnSearch"}, 
                                                             "response" : {"target" : "app-main"},
                                                             "form" : "frmSearch"}`)
